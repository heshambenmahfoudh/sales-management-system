...
import {   productQtyColumn } from "@/app/(dummy)/data"
import { useMemo } from "react"
import { spliteObject } from "@/lib/spliteItem"

export default function ProductsQtyData({data,permission}) {
  const {
    register,
    watch,
    formState: { errors },
...
return (
     <div>
    <FixedHeader
           linkUrl="/dashboard/inventory/products-quantitaies/new"
           textValue="Products Quantities"
           numberData={newData?.length | 0}
           isHidden={!permission?.productsQuantitaesDataCreate}
         />
           ...
           <DataTable
                     ...
                     onDeleted={permission?.productsQuantitaesDataDelete}
                     linkToCreate="/dashboard/inventory/products-quantitaies/new"
                     endPoint="products/products-quantities"
                     titleToCreate="products quantities"
                     resourceName="Product Quantity"
                   />
