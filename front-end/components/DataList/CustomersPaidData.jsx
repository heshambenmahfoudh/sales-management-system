...
import { customerPaidColumn } from "@/app/(dummy)/data"

export default function CustomersPaidData({data,permission}) {
  const {
    register,
    watch,
    formState: { errors },
  ...
  return (
    ...
    <FixedHeader
         ...
         />
           ...
           <DataTable
              data={newData}
              columns={customerPaidColumn}
              onUpdated={permission?.customersPaidUpdate}
              onDeleted={permission?.customersPaidDelete}
