...
export default function UsersData({data,permission}) {
  const {
    register,
    watch,
    formState: { errors },
  ...
  return (
     <div>
       <FixedHeader
               ...
               isHidden={!permission?.userDataCreate}
             />
           ...
           <DataTable
                    data={newData}
                    columns={userColumn}
                    onUpdated={permission?.userDataUpdate}
                    onDeleted={permission?.userDataDelete}
