...
import { supplierDelayColumn } from "@/app/(dummy)/data"
import { useMemo } from "react"
import { spliteObject } from "@/lib/spliteItem"

export default function SuppliersDelayData({data,permission}) {
  const {
    register,
    watch,
    formState: { errors },
  ...
  return (
     ...
     <FixedHeader
          ...
          />
            ...
            <DataTable
                     data={newData}
                     columns={supplierDelayColumn}
                     onUpdated={permission?.suppliersDelayedUpdate}
                     onDeleted={permission?.suppliersDelayedDelete}
                     linkToUpdate="/dashboard/suppliers/suppliers-delayed/update/"
                     endPoint="suppliers/suppliers-mony"
                     resourceName="Supplier Delay"
                   />
        </div>
  )
}
